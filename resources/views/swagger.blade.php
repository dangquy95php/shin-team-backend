...
<html lang="en">
  ...
  <body>
    ...
    <script src="{{asset('swagger-ui/dist/swagger-ui-bundle.js')}}" charset="UTF-8"> </script>
    <script src="{{asset('swagger-ui/dist/swagger-ui-standalone-preset.js')}}" charset="UTF-8"> </script>
    <script>
    window.onload = function() {
      // Begin Swagger UI call region
      const ui = SwaggerUIBundle({
        url: "{{asset('api_docs/swagger.yaml')}}",
        dom_id: '#swagger-ui',
        validatorUrl: null,
        deepLinking: true,
        presets: [
